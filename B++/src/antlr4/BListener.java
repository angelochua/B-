...
public interface BListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link BParser#missingSCOLON}.
	 * @param ctx the parse tree
	 */
	void enterMissingSCOLON(BParser.MissingSCOLONContext ctx);
	/**
	 * Exit a parse tree produced by {@link BParser#missingSCOLON}.
	 * @param ctx the parse tree
	 */
	void exitMissingSCOLON(BParser.MissingSCOLONContext ctx);
	/**
